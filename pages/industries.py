...
from services.ui import GRAPH_CONFIG, page_head
    ...
    return html.Div([
        ...
        html.Div(className="card", children=[
            html.Div(className="controls", children=[
                html.Div(className="control grow", children=[
            ...
            dcc.Graph(id="ind-chart", config=GRAPH_CONFIG,
        ...
        html.Div(className="card", children=[
            ...
            html.P("Total return of each industry index from ChatGPT's launch to the latest close.",
                   className="muted"),
            dcc.Graph(id="ind-scorecard", config=GRAPH_CONFIG,
                      style={"height": "460px"}),
            html.P(
...
def update_chart(industries, year_range, theme_key):
    ...
    for name in columns:
        ...
        fig.add_trace(go.Scatter(
            ...
            line=dict(color=colors[name], width=2, dash="dash" if is_benchmark else "solid"),
...
@callback(Output("ind-scorecard", "figure"), Input("theme", "data"))
def update_scorecard(theme_key):
    scores = scorecard()
    colors = theme.industry_colors(theme_key)
