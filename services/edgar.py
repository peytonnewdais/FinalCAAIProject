...
We used AI to understand and use the edgar endpoitns. AI generated the majority of code in this file and helped us with packages needed. 
We also got the original Idea to use this API from asking claude 
"""
import json
import re
import time
